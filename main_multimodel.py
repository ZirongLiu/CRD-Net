...
def parse_args():
    ...
    parser.add_argument('--data_root', type=str, default='/data0/liuzirong/datasets/FEVRdataset/dataset', help='Root directory of dataset')
    parser.add_argument('--csv_file', type=str, default='/data0/liuzirong/datasets/FEVRdataset/dataset-train_test.csv', help='CSV file with train/test split')
